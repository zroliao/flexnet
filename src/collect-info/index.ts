...
async function getPublicIpAddress1(): Promise<string | null> {
  return await Promise.race([
    getPublicIpAddressFn("https://api.ipify.org"),
    timeout(3000),
  ]);
}
...
async function getPublicIpAddress2(): Promise<string | null> {
  return await Promise.race([
    getPublicIpAddressFn("https://ip4.seeip.org"),
    timeout(3000),
  ]);
}
...
async function getPublicIpAddress3(): Promise<string | null> {
  return await Promise.race([
    getPublicIpAddressFn("https://ipinfo.io/ip"),
    timeout(3000),
  ]);
}

async function getPublicIpAddress4(): Promise<string | null> {
  return await Promise.race([getPublicIpFromIp4Me(), timeout(3000)]);
}

async function getPublicIpFromIp4Me(): Promise<string | null> {
  return new Promise<string | null>((done) => {
    http
      .get("http://ip4only.me/api/", (response) => {
        // * handle HTTP response
        // * ======================================
        response.setEncoding("utf8");
        response.on("data", (data) => {
...
async function collectFromSource1(): Promise<FlexNet.GeoIP | null> {
  return new Promise<FlexNet.GeoIP | null>((done) => {
    https
      .get("https://api.ip.sb/geoip", (response) => {
        // * handle HTTP response
        // * ======================================
        response.setEncoding("utf8");
        response.on("data", (data) => {
...
async function collectFromSource2(): Promise<FlexNet.GeoIP | null> {
  return new Promise<FlexNet.GeoIP | null>((done) => {
    https
      .get("https://ipwho.is/", (response) => {
        // * handle HTTP response
        // * ======================================
        response.setEncoding("utf8");
        response.on("data", (data) => {
...
async function collectFromSource3(): Promise<FlexNet.GeoIP | null> {
  return new Promise<FlexNet.GeoIP | null>((done) => {
    http
...
export default async function (): Promise<FlexNet.GeoIP | null> {
  let retval: FlexNet.GeoIP | null = null;
